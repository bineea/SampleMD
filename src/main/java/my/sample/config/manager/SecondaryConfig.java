...
@EnableJpaRepositories(
		basePackages ={ AppConfig.APP_NAME + ".dao.secondary.repo.jpa"}, 
...
public class SecondaryConfig {
	...
	public LocalContainerEntityManagerFactoryBean secondaryEntityManager()
	{
		...
		entityFactory.setDataSource(secondaryDataSource);
		entityFactory.setPackagesToScan(new String[] {AppConfig.APP_NAME+".dao.secondary.entity"});
	...
	public JpaTransactionManager secondaryTransactionManager()
	{
		...
		transactionManager.setEntityManagerFactory(this.secondaryEntityManager().getObject());
		return transactionManager;
	}
	
	@Bean(name = "secondaryAnnotationTransactionAspect")
	public AnnotationTransactionAspect annotationTransactionAspect() {
		...
		aspect.setTransactionManager(secondaryTransactionManager());
		return aspect;
	}
}
